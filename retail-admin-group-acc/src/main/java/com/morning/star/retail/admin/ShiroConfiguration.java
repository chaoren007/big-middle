...
//    }
    ...
    public CacheManager springCacheManager(RedisTemplate<String, String> redisTemplate) {
        ...
        expires.put("authenticationCache", 60*60*12L);
        expires.put("authorizationCache", 60*60*12L);
        expires.put("activeSessionsCache", 60*60*12L);
        expires.put("passwordRetryCache", 60*60*12L);
