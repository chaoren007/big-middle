...
public class BeanUtils {
	...
	private static final BigDecimalConverter BIGDECIMAL_CONVERTER = new BigDecimalConverter(null);
	...
	static {
		...
		ConvertUtils.register(BIGDECIMAL_CONVERTER, java.math.BigDecimal.class);
	}
