package com.morning.star.retail.admin.group.login.controller;
...
public class LoginController extends AdminController {
    ...
    public WebJsonBean login(@RequestBody UserLogin userLogin) {
        LoggerUtil.info(getClass(), "start ----------- admin-group-acc-login ----------- ");
        LoginUser loginUser = TokenManager.login(userLogin, PlatformEnum.GROUP);
        LoggerUtil.info(getClass(), "end ----------- admin-group-acc-login ----------- ");
    ...
    public WebJsonBean logout() {
        LoggerUtil.info(getClass(), "start ----------- admin-group-acc-logout ----------- ");
        TokenManager.logout();
        LoggerUtil.info(getClass(), "end ----------- admin-group-acc-logout ----------- ");
        return success();
    }
