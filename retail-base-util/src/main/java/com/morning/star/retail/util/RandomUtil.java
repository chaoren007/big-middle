...
public class RandomUtil {
    ...
    /**
     * 生成token（用户id(8位，不足前面补0)+随机字符串）
     *
     * @param userId
     * @return
     */
    public static String generateToken(long userId) {
        return toFixdLengthString(userId, 8) + generateString(RetailDefaultConst.TOKEN_LENGTH);
    }
    ...
    public static String generateSalt() {
        return generateString(RetailDefaultConst.SALT_LENGTH);
    }
