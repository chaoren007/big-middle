...
public class BeanUtils {
	...
	static {
		...
		registerDeserializer(new RequestTagEnum.BeanDeserializer(), RequestTagEnum.class);
		registerSerializer(new RequestTagEnum.BeanSerializer(), RequestTagEnum.class, Integer.class);

		registerDeserializer(new RequestStatusEnum.BeanDeserializer(), RequestStatusEnum.class);
		registerSerializer(new RequestStatusEnum.BeanSerializer(), RequestStatusEnum.class, Integer.class);

		registerDeserializer(new RequestTypeEnum.BeanDeserializer(), RequestTypeEnum.class);
		registerSerializer(new RequestTypeEnum.BeanSerializer(), RequestTypeEnum.class, Integer.class);
...
//
//		registerDeserializer(new CommodityTypeEnum.BeanDeserializer(), CommodityTypeEnum.class);
//		registerSerializer(new CommodityTypeEnum.BeanSerializer(), CommodityTypeEnum.class, Integer.class);
	}
