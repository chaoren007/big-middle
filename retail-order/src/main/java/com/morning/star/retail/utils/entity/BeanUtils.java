...
public class BeanUtils {
	...
	static {
		...
		registerDeserializer(new AfterSalesTypeEnum.BeanDeserializer(), AfterSalesTypeEnum.class);
		registerSerializer(new AfterSalesTypeEnum.BeanSerializer(), AfterSalesTypeEnum.class, Integer.class);
	}
