...
import com.morning.star.retail.entity.GroupType;
...
public class BeanUtils {
	...
	static {
		...
		registerDeserializer(new GroupType.BeanDeserializer(), GroupType.class);
		registerSerializer(new GroupType.BeanSerializer(), GroupType.class, Integer.class);

		registerDeserializer(new StoreModelType.BeanDeserializer(), StoreModelType.class);
		registerSerializer(new StoreModelType.BeanSerializer(), StoreModelType.class, Integer.class);
	}
