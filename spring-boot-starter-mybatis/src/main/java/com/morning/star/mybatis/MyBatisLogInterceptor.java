package com.morning.star.mybatis;
...
public class MyBatisLogInterceptor implements Interceptor {
    protected Logger logger = LoggerFactory.getLogger("com.morning.star.SL");

    private Method requestQueryMethod;
    public MyBatisLogInterceptor() {
        try {
            Class logContextClass = Class.forName("com.morning.star.log.LogContext", false, this.getClass().getClassLoader());
