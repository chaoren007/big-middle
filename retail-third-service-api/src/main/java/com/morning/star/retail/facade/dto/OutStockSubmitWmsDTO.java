...
/**
 * 外部服务出库dto（S-销售出库单，P-调拨出库单）
 */
@ApiModel
public class OutStockSubmitWmsDTO implements Serializable {
	...
	private List<OutStockDetailSubmitWmsDTO> detail;

	public OutStockSubmitWmsDTO() {
	}

	public OutStockSubmitWmsDTO(String outStockCode, String userId, String phone, String username, String address, String operatorName, String createTime, String storeCode, String warehouseCode, String remark) {
	...
	public List<OutStockDetailSubmitWmsDTO> getDetail() {
		return detail;
	}

	public void setDetail(List<OutStockDetailSubmitWmsDTO> detail) {
		this.detail = detail;
	}
}
