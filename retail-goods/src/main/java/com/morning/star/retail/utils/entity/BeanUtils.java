...
public class BeanUtils {
	...
	static {
		...
		registerDeserializer(new GoodsSupplyStatus.BeanDeserializer(), GoodsSupplyStatus.class);
		registerSerializer(new GoodsSupplyStatus.BeanSerializer(), GoodsSupplyStatus.class, Integer.class);
		...
		registerDeserializer(new StorageTypeEnum.BeanDeserializer(), StorageTypeEnum.class);
		registerSerializer(new StorageTypeEnum.BeanSerializer(), StorageTypeEnum.class, Integer.class);
	}
