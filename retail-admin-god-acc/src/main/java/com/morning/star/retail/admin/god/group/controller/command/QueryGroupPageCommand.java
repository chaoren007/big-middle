package com.morning.star.retail.admin.god.group.controller.command;
 ...
 * Created by kimhuhg.
 */
public class QueryGroupPageCommand implements Serializable {
    ...
    public QueryGroupPageCommand() {
    }

    public QueryGroupPageCommand(String groupCode) {
