package com.morning.star.retail.admin.address.controller;
...
public class AddressController extends AdminController {
	...
	public WebBean<List<CityDTO>> cities() {
		StoreDTO storeDTO = storeFacade.getStore(getLoginAdmin().getStoreCode());
		List<CityDTO> list = new ArrayList<>();
		CityDTO cityDTO = new CityDTO();
		cityDTO.setCityId(storeDTO.getCityId());
		cityDTO.setCityName(storeDTO.getCityName());
		list.add(cityDTO);
