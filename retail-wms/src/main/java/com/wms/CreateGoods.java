 ...
 *       &lt;sequence>
 *         &lt;element name="list" type="{http://vo.wms.com/xsd}Goods" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="list2" type="{http://vo.wms.com/xsd}Goods" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateGoods")
public class CreateGoods {

    @XmlElement(nillable = true)
    protected List<Goods> list;
    @XmlElement(nillable = true)
    protected List<Goods> list2;
